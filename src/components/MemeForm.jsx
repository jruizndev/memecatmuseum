    ...
    <div className="rounded-lg relative inline-block text-gray p-4 bg-gray-100 shadow-lg w-full max-w-lg mx-auto transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-gray-200 hover:shadow-2xl">
      ...
      <form onSubmit={handleSubmit(onSubmitHandler)} className="space-y-5">
        ...
        <div className="flex flex-col sm:flex-row justify-center mt-4 space-y-4 sm:space-y-0 sm:space-x-4">
          <button
            type="submit"
            className="bg-black text-white py-2 px-4 text-sm rounded-[20px] transition-all duration-300 ease-in-out hover:bg-green-500 w-full sm:w-auto"
          >
            {submitButtonText}
          </button>
          <button
            type="button"
            onClick={onClose}
            className="bg-red-500 text-white py-1 px-5 rounded-3xl border-2 border-transparent transition-all duration-300 ease-in-out hover:bg-white hover:border-black hover:text-black"
          >
            Cancelar
          </button>
        </div>
