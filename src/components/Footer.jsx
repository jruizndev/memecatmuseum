  ...
  return (
    <footer className="bg-black text-white py-2">
      ...
      <div className="w-full h-auto px-4 sm:px-6 lg:px-12 pt-6 sm:pt-3 lg:pt-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-6 mb-6 items-start">
        {/* Follow Us Section */}
        <div className="flex flex-col items-center sm:items-center lg:items-center relative"> {/* Cambié items-end a items-center para centrar */}
          {/* Logo principal */}
          <div className="container flex flex-col items-center">
            <img className="w-28 sm:w-20 md:w-56 lg:w-64 rounded-full border-black mb-4 mr-12 lg:mb-6" src="/src/assets/icons/LogoBlanco2.png" alt="Icon" /> {/* Ajusté el mb */}
            ...
            <div className="flex flex-col items-center text-center mr-24">
              ...
              <div className="flex gap-4 mt-2 justify-center"> {/* Eliminé los justify-end para centrar */}
                {/* Instagram */}
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                  <img src="/src/assets/icons/logoIgGato.png" className="w-8 sm:w-6 md:w-12 lg:w-16" alt="Instagram Logo" />
                </a>
                {/* Facebook */}
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                  <img src="/src/assets/icons/logoFacebookGato.png" className="w-8 sm:w-6 md:w-12 lg:w-16" alt="Facebook Logo" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center sm:items-center md:items-start">
          ...
          <ul className="mt-2 space-y-2 text-center sm:text-center md:text-left">
            <li><a href="#about" className="text-[#eee8e1] text-base opacity-50">About</a></li>
            <li><a href="#reports" className="text-[#eee8e1] text-base opacity-50">Reports</a></li>
            <li><a href="#services" className="text-[#eee8e1] text-base opacity-50">Services</a></li>
            <li><a href="#contact" className="text-[#eee8e1] text-base opacity-50">Contact</a></li>
          </ul>
        </div>
        ...
        <div className="flex flex-col items-center sm:items-center md:items-start">
          ...
          <div className="relative mt-4 w-full sm:w-full md:w-auto">
            <input className="px-16 py-2 text-base text-[#8b8a8a] bg-transparent border-2 border-[#eee8e1]/70 rounded-full w-full pr-12" placeholder="Your email" />
            <button className="absolute right-1 top-1/2 transform -translate-y-1/2">
              <img src="/src/assets/icons/botonCat.png" alt="Submit" className="w-10 lg:w-12 h-10 rounded-full border-2 border-white" />
            </button>
          </div>
        </div>
      </div>
