        ...
        <div className="w-[85vw] flex flex-col items-start">
          <div className="flex flex-col lg:flex-row justify-center items-center lg:gap-60 w-full">
            ...
            <p className="w-full lg:w-[60%] font-inter text-base lg:text-2xl text-center lg:text-left">
              MemeCat es el primer museo virtual dedicado exclusivamente a los
              memes de gatos. Aquí, los amantes de los gatos pueden explorar,
              compartir y reír con los memes más divertidos del mundo felino.
              Nuestro objetivo es celebrar el humor y la creatividad que los
              gatos inspiran en internet, ofreciendo un espacio para que todos
              los fans del "cat-meme" se reúnan y disfruten de lo mejor del
              contenido viral felino. ¡Únete a nuestra comunidad y forma parte
              de la historia del meme gatuno!
            </p>
          </div>
